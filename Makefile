...
# Dangerous options when used on a git directory
# suppress .git 
#clean:    
#	-rm -Rf $(BUILDDIR)/*
docx: 
...
qthelp:
	...
	@echo "# qcollectiongenerator $(BUILDDIR)/qthelp/PyRay.qhcp"
	@echo "To view the help file:"
	@echo "# assistant -collectionFile $(BUILDDIR)/qthelp/PyRay.qhc"
...
devhelp:
	...
	@echo "Build finished."
	@echo "To view the help file:"
	@echo "# mkdir -p $$HOME/.local/share/devhelp/PyRay"
	@echo "# ln -s $(BUILDDIR)/devhelp $$HOME/.local/share/devhelp/PyRay"
	@echo "# devhelp"
